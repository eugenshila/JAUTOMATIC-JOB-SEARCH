"""Learning and certificate records for the Skills Improvement feature.

The module is GUI-independent and stores only local metadata. Course links are
kept as source links; certificates are copied into the workspace by the UI.
"""
...
class LearningStore:
    """JSON-backed store next to profile.json, with managed certificate files."""
